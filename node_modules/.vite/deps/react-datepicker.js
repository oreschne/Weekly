...
var Rt = function(t3) {
  ...
  function o() {
    ...
    return ye(ke(t4 = n.call.apply(n, [this].concat(s3))), "MONTH_REFS", Ce(Array(12)).map(function() {
      ...
      var r2, n2 = t4.props, o2 = n2.day, a4 = n2.selectsStart, s4 = n2.selectsEnd, i3 = n2.selectsRange, p = n2.startDate, c2 = n2.endDate, l = null !== (r2 = t4.props.selectingDate) && void 0 !== r2 ? r2 : t4.props.preSelection;
      return !(!(a4 || s4 || i3) || !l) && (a4 && c2 ? lt(l, c2, e3, o2) : (s4 && p || !(!i3 || !p || c2)) && lt(p, l, e3, o2));
  ...
  function o(t4) {
    ...
    return he(this, o), ye(ke(a3 = n.call(this, t4)), "handleClickOutside", function(e3) {
      ...
      if (a3.props.showMonthYearDropdown && !t5)
        return import_react2.default.createElement(It, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, dateFormat: a3.props.dateFormat, onChange: a3.changeMonthYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, date: a3.state.date, scrollableMonthYearDropdown: a3.props.scrollableMonthYearDropdown });
      ...
      var t5 = new Date(a3.props.selected), r2 = Oe(t5) && Boolean(a3.props.selected) ? "".concat(St(t5.getHours()), ":").concat(St(t5.getMinutes())) : "";
